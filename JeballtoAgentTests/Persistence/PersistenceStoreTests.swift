...
struct PersistenceStoreTests {
  ...
  @Test
  func freshDatabaseIsPersistedAsVersionTwo() async throws {
    try await withTemporaryDirectory(prefix: "persistence-version") { root in
      ...
      #expect(VMDatabase.currentVersion == 2)
    }
  }
