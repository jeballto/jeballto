...
JeballtoAgent runs as a macOS menu-bar app on Apple Silicon (M1+, macOS 26.0+) and serves a REST API on `localhost:8011` by default. All endpoints except `/v1/health` require a Bearer token that is auto-generated on first launch.
